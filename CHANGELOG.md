# ferlab/svclusteringpo: Changelog
...
### `Changed`
- [#2](https://github.com/Ferlab-Ste-Justine/ferlab-svclustering-parental-origin/pull/1) call sample_preprocessing.py script via module b
